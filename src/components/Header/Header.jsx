...
function Header() {
  ...
  return (
    <header className="bg-blue-600 fixed top-0 left-0 w-full z-50 shadow-lg">
        ...
        <nav className="relative">
          <ul className="flex space-x-4 sm:space-x-6 lg:space-x-8">
            ...
            >
              ...
              {activeMenu === 'about' && (
                <ul className="absolute left-0 mt-2 w-48 bg-black text-white shadow-lg">
            ...
            <li
              ...
              onMouseLeave={handleMouseLeave}
            >
              <Link to="/impact" className=" flex items-center text-white">
                Impact
                <i className="fas fa-chevron-down ml-2"></i> {/* Dropdown icon */}
              </Link>
              {activeMenu === 'impact' && (
            ...
            <li
              ...
              onMouseLeave={handleMouseLeave}
            >
              <Link to="/get-involved" className="flex items-center text-white">
                Get Involved
                <i className="fas fa-chevron-down ml-2"></i> {/* Dropdown icon */}
              </Link>
            ...
            >
              ...
              {activeMenu === 'projects' && (
                <ul className="absolute left-0 mt-2 w-48 bg-black text-white shadow-lg">
                  <li><Link to="/ongoing-projects" className="block px-4 py-2 flex items-center "><FaArrowRight className="mr-2" /> Ongoing Projects</Link></li>
                  <li><Link to="/past-projects" className="block px-4 py-2 flex items-center "><FaArrowRight className="mr-2" /> Past Projects</Link></li>
                  <li><Link to="/featured-projects" className="block px-4 py-2 flex items-center"><FaArrowRight className="mr-2" /> Featured Projects</Link></li>
                </ul>
              )}
            </li>
