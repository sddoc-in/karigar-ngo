...
function Mission() {
  return (
    <>
      ...
      {/* <section 1 */}
      <section>
        <div class="grid grid-cols-3 m-14 gap-3 shadow-lg transition-transform transform hover:scale-105 hover:shadow-2xl ">
          <div class="relative m-5  shrink-0 overflow-hidden rounded-xl rounded-r-none bg-white bg-clip-border text-gray-700">
            <img
          ...
          <div class="col-span-2 ...">
            <div class="p-6">
              ...
              <p class="mb-8 block font-sans text-base font-normal leading-relaxed text-gray-700 antialiased">
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Id voluptatibus expedita laboriosam quis optio, fugit veniam reiciendis
                est. Vel inventore, earum delectus accusantium sunt atque? Rerum iste maxime similique doloribus.
              </p>
